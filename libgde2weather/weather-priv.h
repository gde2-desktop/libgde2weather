...
const char *gde2weather_gettext (const char *str) G_GNUC_FORMAT (1);
const char *gde2weather_dpgettext (const char *context, const char *str) G_GNUC_FORMAT (2);
#define _(str) (gde2weather_gettext (str))
#define C_(context, str) (gde2weather_dpgettext (context, str))
#define N_(str) (str)


#define WEATHER_LOCATION_CODE_LEN 4

WeatherLocation *gde2weather_location_to_weather_location (Gde2WeatherLocation *gloc,
							const char *name);
