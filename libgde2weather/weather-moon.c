...
/* weather-moon.c - Lunar calculations for gde2weather
 *
...
/*
 * Elements of the Moon's gde2corba, epoch 2000 Jan 1.5
...
calc_moon_phases (WeatherInfo *info, time_t *phases)
{
	...
	/*
	 * First estigde2 on how far the moon needs to advance
