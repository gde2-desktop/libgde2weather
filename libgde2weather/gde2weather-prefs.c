...
/* gde2weather-prefs.c - Preference handling functions
 *
...
#include "gde2weather-prefs.h"
#include "weather-priv.h"

/**
 * SECTION:gde2weather-prefs
 * @Title: gde2weather-prefs
 */

void
gde2weather_prefs_load (Gde2WeatherPrefs *prefs, GSettings *settings)
{
...
const char *
gde2weather_prefs_get_temp_display_name (TempUnit temp)
{
    switch (temp) {
...
const char *
gde2weather_prefs_get_speed_display_name (SpeedUnit speed)
{
    switch (speed) {
...
const char *
gde2weather_prefs_get_pressure_display_name (PressureUnit pressure)
{
    switch (pressure) {
...
const char *
gde2weather_prefs_get_distance_display_name (DistanceUnit distance)
{
    switch (distance) {
