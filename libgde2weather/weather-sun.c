...
/* weather-sun.c - Astronomy calculations for gde2weather
 *
...
sunEclipLongitude(time_t t)
{
    ...
    /*
     * Start with an estigde2 based on a fixed daily rate
     */
    ...
    /*
     * Approxigde2 solution of Kepler's equation:
...
calc_sun2 (WeatherInfo *info, time_t t)
{
    ...
    /* Approxigde2 preceding local midnight at observer's longitude */
